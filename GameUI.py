...
class GUI:
    ...
    def __init__(self, board_size=11):
        ...
        # Set the SDL window position environment variable
        ...
        # Set the window style to remove the icon
        import ctypes
        GWL_STYLE = -16
        ...
        self.UnitSize = 48     # the basic size of all elements, try a different value!
    ...
    def reset(self, bs):
        ...
        pygame.display.set_caption('Gobang_AI by Alex GENG')
